...
optional kclibs declared by `manifest.json:kclib`, discovers their public
functions from the extracted `libNAME.h` headers at build time, and retains
the WebView trusted-origin capability gate before every native operation.
