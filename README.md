...
- Project JNI/native integration belongs in `proj/NAME/native/`.
...
A project has a small declarative contract in `proj/NAME/config.json`.
...
`proj/NAME/app/` is generated by the builder.

Do not edit it by hand.

Changes to generated Java, JNI dispatch, AndroidManifest.xml, native packaging,
or other generated behavior belong in `build.sh`.
...
`proj/NAME/native/bridge.c` remains available for project-specific native
